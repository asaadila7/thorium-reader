...
import { storeHighlight } from 'path/to/highlight/actions'; 
//Added the import statement. Have to update the path with ACTUAL PATH
...
export class ReaderMenu extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactElement<{}> {
        ...
        const sections: SectionData[] = [
            ...
            {
                title: __("reader.marks.highlights"),
                content: this.renderHighlightList(), // Define this function to render the list of highlights
